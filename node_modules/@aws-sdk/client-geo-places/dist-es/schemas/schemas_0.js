...
export var CountryCode2 = [0, n0, _CCo, 8, 0];
export var CountryCode3 = [0, n0, _CCou, 8, 0];
export var DistanceMeters = [0, n0, _DM, 8, 1];
export var DurationSeconds = [0, n0, _DS, 8, 1];
export var GeocodeFilterPlaceType = [0, n0, _GFPT, 8, 0];
export var OpeningHoursDisplay = [0, n0, _OHD, 8, 0];
export var PlaceType = [0, n0, _PT, 8, 0];
export var PostalAuthority = [0, n0, _PA, 8, 0];
export var PostalCodeType = [0, n0, _PCT, 8, 0];
export var RecordTypeCode = [0, n0, _RTC, 8, 0];
export var SensitiveBoolean = [0, n0, _SB, 8, 2];
export var SensitiveString = [0, n0, _SS, 8, 0];
export var ZipClassificationCode = [0, n0, _ZCC, 8, 0];
...
export var AccessPointList = [1, n0, _APL, 0, [() => AccessPoint, 0]];
export var AccessRestrictionList = [1, n0, _ARL, 0, [() => AccessRestriction, 0]];
export var AutocompleteAdditionalFeatureList = 64 | 0;
export var AutocompleteFilterPlaceTypeList = 64 | 0;
export var AutocompleteResultItemList = [1, n0, _ARIL, 0, [() => AutocompleteResultItem, 0]];
export var BoundingBox = [1, n0, _BB, 8, 1];
export var BusinessChainList = [1, n0, _BCL, 0, [() => BusinessChain, 0]];
export var CategoryList = [1, n0, _CL, 0, [() => Category, 0]];
export var ContactDetailsList = [1, n0, _CDL, 0, [() => ContactDetails, 0]];
export var CountryCodeList = [1, n0, _CCL, 0, [() => CountryCode, 0]];
export var FilterBusinessChainList = [1, n0, _FBCL, 0, [() => SensitiveString, 0]];
export var FilterCategoryList = [1, n0, _FCL, 0, [() => SensitiveString, 0]];
export var FilterFoodTypeList = [1, n0, _FFTL, 0, [() => SensitiveString, 0]];
export var FoodTypeList = [1, n0, _FTL, 0, [() => FoodType, 0]];
export var GeocodeAdditionalFeatureList = 64 | 0;
export var GeocodeFilterPlaceTypeList = [1, n0, _GFPTL, 0, [() => GeocodeFilterPlaceType, 0]];
export var GeocodeResultItemList = [1, n0, _GRIL, 0, [() => GeocodeResultItem, 0]];
export var GetPlaceAdditionalFeatureList = 64 | 0;
export var HighlightList = [1, n0, _HL, 0, [() => Highlight, 0]];
export var IntersectionHighlightsList = [1, n0, _IHL, 0, [() => HighlightList, 0]];
export var IntersectionList = [1, n0, _IL, 0, [() => Intersection, 0]];
export var IntersectionStreetList = 64 | 0;
export var MatchScoreList = 64 | 1;
export var OpeningHoursComponentsList = [1, n0, _OHCL, 0, [() => OpeningHoursComponents, 0]];
export var OpeningHoursDisplayList = [1, n0, _OHDL, 0, [() => OpeningHoursDisplay, 0]];
export var OpeningHoursList = [1, n0, _OHL, 0, [() => OpeningHours, 0]];
export var ParsedQueryComponentList = [1, n0, _PQCL, 0, [() => ParsedQueryComponent, 0]];
export var ParsedQuerySecondaryAddressComponentList = [
    1,
    n0,
    _PQSACL,
    0,
...
export var PhonemeTranscriptionList = [1, n0, _PTL, 0, [() => PhonemeTranscription, 0]];
export var Position = [1, n0, _P, 8, 1];
export var PostalCodeDetailsList = [1, n0, _PCDL, 0, [() => PostalCodeDetails, 0]];
export var QueryRefinementList = [1, n0, _QRL, 0, [() => QueryRefinement, 0]];
export var RelatedPlaceList = [1, n0, _RPL, 0, [() => RelatedPlace, 0]];
export var ReverseGeocodeAdditionalFeatureList = 64 | 0;
export var ReverseGeocodeFilterPlaceTypeList = 64 | 0;
export var ReverseGeocodeResultItemList = [1, n0, _RGRIL, 0, [() => ReverseGeocodeResultItem, 0]];
export var SearchNearbyAdditionalFeatureList = 64 | 0;
export var SearchNearbyResultItemList = [1, n0, _SNRIL, 0, [() => SearchNearbyResultItem, 0]];
export var SearchTextAdditionalFeatureList = 64 | 0;
export var SearchTextResultItemList = [1, n0, _STRIL, 0, [() => SearchTextResultItem, 0]];
export var SecondaryAddressComponentList = [1, n0, _SACL, 0, [() => SecondaryAddressComponent, 0]];
export var SecondaryAddressComponentMatchScoreList = [
    1,
    n0,
    _SACMSL,
    0,
...
export var StreetComponentsList = [1, n0, _SCL, 0, [() => StreetComponents, 0]];
export var SuggestAdditionalFeatureList = 64 | 0;
export var SuggestResultItemList = [1, n0, _SRIL, 0, [() => SuggestResultItem, 0]];
