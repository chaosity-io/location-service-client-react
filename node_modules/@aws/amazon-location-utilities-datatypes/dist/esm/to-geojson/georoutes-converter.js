 ...
 * ```
 */
export function calculateRoutesResponseToFeatureCollections(routesResponse, options) {
    const routes = [];
 ...
 * ```
 */
export function calculateIsolinesResponseToFeatureCollection(isolinesResponse, options) {
 ...
 * ```
 */
export function optimizeWaypointsResponseToFeatureCollection(waypointsResponse, options) {
    const waypoints = {
        type: "FeatureCollection",
        features: [],
    };
 ...
 * ```
 */
export function snapToRoadsResponseToFeatureCollection(snapToRoadsResponse, options) {
    // Set any options that weren't passed in to the default values.
