...
exports.suggestResponseToFeatureCollection = exports.searchTextResponseToFeatureCollection = exports.searchNearbyResponseToFeatureCollection = exports.reverseGeocodeResponseToFeatureCollection = exports.geocodeResponseToFeatureCollection = exports.getPlaceResponseToFeatureCollection = void 0;
 ...
 * @group GeoPlaces
 */
function getPlaceResponseToFeatureCollection(response, options) {
    ...
    const collection = (0, utils_1.emptyFeatureCollection)();
...
exports.getPlaceResponseToFeatureCollection = getPlaceResponseToFeatureCollection;
 ...
 * @group GeoPlaces
 */
function geocodeResponseToFeatureCollection(response, options) {
    var _a;
    // Set any options that weren't passed in to the defaults.
...
exports.geocodeResponseToFeatureCollection = geocodeResponseToFeatureCollection;
 ...
 * @group GeoPlaces
 */
function reverseGeocodeResponseToFeatureCollection(response, options) {
    var _a;
    // Set any options that weren't passed in to the defaults.
...
exports.reverseGeocodeResponseToFeatureCollection = reverseGeocodeResponseToFeatureCollection;
 ...
 * @group GeoPlaces
 */
function searchNearbyResponseToFeatureCollection(response, options) {
    var _a;
    // Set any options that weren't passed in to the defaults.
...
exports.searchNearbyResponseToFeatureCollection = searchNearbyResponseToFeatureCollection;
 ...
 * @group GeoPlaces
 */
function searchTextResponseToFeatureCollection(response, options) {
    var _a;
    // Set any options that weren't passed in to the defaults.
...
exports.searchTextResponseToFeatureCollection = searchTextResponseToFeatureCollection;
 ...
 * @group GeoPlaces
 */
function suggestResponseToFeatureCollection(response, options) {
    var _a, _b, _c;
    // Set any options that weren't passed in to the defaults.
...
exports.suggestResponseToFeatureCollection = suggestResponseToFeatureCollection;
/**
...
function addGeoJsonPointFeature(collection, coordinates, properties, flatten) {
    if (coordinates) {
        ...
        collection.features.push({
            ...
            properties: flatten ? (0, utils_1.flattenProperties)(propertiesClone) : propertiesClone,
            geometry: {
                type: "Point",
