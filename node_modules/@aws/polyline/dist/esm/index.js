...
import { ThirdDimension, CompressionAlgorithm, } from "./polyline-types";
export { ThirdDimension, CompressionAlgorithm };
 ...
 */
export function setCompressionAlgorithm(compressionType) {
 ...
 */
export function encodeFromLngLatArray(lngLatArray, parameters = {}) {
 ...
 * ```
 */
export function decodeToLngLatArray(compressedData) {
 ...
 * ```
 */
export function decodeToLineString(encodedData) {
 ...
 * ```
 */
export function decodeToPolygon(encodedData) {
 ...
 * ```
 */
export function decodeToLineStringFeature(encodedData) {
 ...
 * ```
 */
export function decodeToPolygonFeature(encodedData) {
