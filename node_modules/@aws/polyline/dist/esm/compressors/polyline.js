...
class EncodedPolyline extends DataCompressor {
    constructor(precision) {
        ...
        this.PolylineEncodingTable = "?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
        ...
        this.encoder = new PolylineEncoder(this.PolylineEncodingTable, this.DataContainsHeader);
        this.decoder = new PolylineDecoder(this.PolylineDecodingTable, this.DataContainsHeader);
        this.precision = precision;
    }
    compressLngLatArray(lngLatArray) {
        return this.encoder.encode(lngLatArray, this.precision);
    }
    decompressLngLatArray(compressedData) {
        const [lngLatArray, header] = this.decoder.decode(compressedData, this.precision);
