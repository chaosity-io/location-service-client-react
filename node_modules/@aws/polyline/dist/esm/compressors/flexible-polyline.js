...
import { DefaultPrecision, ThirdDimension, } from "../polyline-types";
...
export class FlexiblePolyline extends DataCompressor {
    constructor() {
        ...
        this.FlexPolylineEncodingTable = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
        ...
        this.encoder = new PolylineEncoder(this.FlexPolylineEncodingTable, this.DataContainsHeader);
        this.decoder = new PolylineDecoder(this.FlexPolylineDecodingTable, this.DataContainsHeader);
    }
    compressLngLatArray(lngLatArray, parameters) {
        ...
        const fullParameters = Object.assign(Object.assign({}, DefaultCompressionParameters), parameters);
        return this.encoder.encode(lngLatArray, fullParameters.precisionLngLat, fullParameters.thirdDimension, fullParameters.precisionThirdDimension);
    }
    decompressLngLatArray(encodedData) {
